...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .card h2 { color: #1e3a8a; margin-bottom: 1.5rem; font-size: 1.4rem; }
        ...
        .status-badge { padding: 0.5rem 1rem; border-radius: 20px; font-weight: 700; display: inline-block; }
        ...
        .total-row { background: #f9fafb; padding: 1rem; border-radius: 8px; margin-top: 1rem; display: flex; justify-content: space-between; }
        .total-label { font-size: 1.2rem; font-weight: 700; color: #1e3a8a; }
        .total-value { font-size: 1.5rem; font-weight: 700; color: #10b981; }
        
        .actions { display: flex; gap: 1rem; margin-top: 2rem; }
        .btn { padding: 0.75rem 2rem; border-radius: 8px; font-weight: 600; text-decoration: none; display: inline-block; text-align: center; }
...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="info-grid">
                <div class="info-row">
                    ...
                    <span class="info-value">#<%= reservation.getReservationId() %></span>
                </div>
                <div class="info-row">
        ...
        <div class="card">
            ...
            <div class="info-grid">
                <div class="info-row">
                    ...
                    <span class="info-value">#<%= guest != null ? guest.getUserId() : reservation.getGuestId() %></span>
                </div>
                <div class="info-row">
        ...
        <div class="card">
            ...
            <div class="info-grid">
                <div class="info-row">
                    ...
                    <span class="info-value"><%= room != null ? room.getRoomNumber() : "Room #" + reservation.getRoomId() %></span>
                </div>
                <div class="info-row">
                ...
                <% if (reservation.getSpecialRequests() != null && !reservation.getSpecialRequests().trim().isEmpty()) { %>
                    <div class="info-row">
                        ...
                        <span class="info-value"><%= reservation.getSpecialRequests() %></span>
                    </div>
                <% } %>
            </div>
        ...
        <div class="actions">
            <a href="<%= request.getContextPath() %>/admin/reservations" class="btn btn-secondary">← Back to List</a>
        </div>
    </div>
</body>
</html>
