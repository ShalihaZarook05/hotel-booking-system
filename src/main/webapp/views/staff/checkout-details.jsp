...
<head>
    ...
    <title>Check-Out Details - Ocean View Resort</title>
    <style>
...
<body>
    ...
    <div class="container">
        ...
        <div class="actions">
            <a href="<%= request.getContextPath() %>/staff/checkout/form?id=<%= reservation.getReservationId() %>" class="btn btn-primary">💳 Process Check-Out</a>
            <a href="<%= request.getContextPath() %>/staff/checkout" class="btn btn-secondary">← Back to Check-Outs</a>
        </div>
    </div>
</body>
</html>
